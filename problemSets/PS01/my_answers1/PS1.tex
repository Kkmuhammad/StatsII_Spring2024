...
\lstinputlisting[language=R, firstline=39, lastline=64]{PS1.R}
\newpage
...
\textbf{		The R script is:}
\lstinputlisting[language=R, firstline=75, lastline=98]{PS1.R}
